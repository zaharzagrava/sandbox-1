...
export enum ErrorCodes {
  ...
  NOTIFICAION_ACCESS_UNAUTHENTICATED = "NOTIFICAION_ACCESS_UNAUTHENTICATED",
  EVENT_ACCESS_UNAUTHENTICATED = "EVENT_ACCESS_UNAUTHENTICATED",
  USER_ACCESS_UNAUTHENTICATED = "USER_ACCESS_UNAUTHENTICATED",
  DOCUMENT_ACCESS_UNAUTHENTICATED = "DOCUMENT_ACCESS_UNAUTHENTICATED",
}
